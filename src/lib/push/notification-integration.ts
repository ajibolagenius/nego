...
export async function sendPushForNotification(
    ...
    try {
        ...
        const iconMap: Record<string, string> = {
            ...
            booking_cancelled: '/icon.svg',
            booking_expired: '/icon.svg',
            withdrawal_approved: '/icon.svg',
            withdrawal_rejected: '/icon.svg',
            purchase_success: '/icon.svg',
            purchase_failed: '/icon.svg',
            low_balance: '/icon.svg',
            media_unlocked: '/icon.svg',
            gift_received: '/icon.svg',
            gift_sent: '/icon.svg',
            message_received: '/icon.svg',
            dispute_filed: '/icon.svg',
            dispute_resolved: '/icon.svg',
            review_received: '/icon.svg',
            verification_approved: '/icon.svg',
            talent_verified: '/icon.svg',
            talent_unverified: '/icon.svg',
            media_deleted: '/icon.svg',
            general: '/icon.svg',
        }
