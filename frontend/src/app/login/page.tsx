...
import { Eye, EyeSlash, Envelope, Lock, SpinnerGap, GoogleLogo } from '@phosphor-icons/react'
        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-8 border border-white/10">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="text-right">
              <Link href="/forgot-password" className="text-[#df2531] text-sm hover:underline">
                Forgot password?
              </Link>
            </div>
          ...
          <p className="text-center text-white/50 text-sm mt-6">
            ...
            <Link href="/register" className="text-[#df2531] hover:underline">
              Sign up
            </Link>
          </p>
        </div>
