    ...
    <div className="space-y-4" data-testid="media-manager">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className={`p-2.5 rounded-lg transition-all focus:outline-none focus:ring-2 focus:ring-[#df2531] focus:ring-offset-2 focus:ring-offset-black ${
      ...
      <div className="flex gap-2">
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2.5 rounded-full text-sm font-medium transition-all focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-black ${
            activeTab === 'free'
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2.5 rounded-full text-sm font-medium transition-all focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 focus:ring-offset-black ${
            activeTab === 'premium'
            ...
            <div className="flex-1 min-w-[150px]">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-1.5 py-2.5 px-3 rounded-lg text-sm transition-all focus:outline-none focus:ring-2 focus:ring-[#df2531] focus:ring-offset-2 focus:ring-offset-black ${
                    sortBy === 'newest'
            ...
            <div className="flex-1 min-w-[200px]">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`flex-1 py-2.5 px-3 rounded-lg text-sm transition-all focus:outline-none focus:ring-2 focus:ring-[#df2531] focus:ring-offset-2 focus:ring-offset-black ${
                    filterBy === 'all'
                      ? 'bg-[#df2531] text-white shadow-lg shadow-[#df2531]/20'
                      : 'bg-white/10 text-white/60 hover:text-white hover:bg-white/20'
                  }`}
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex items-center justify-between p-4 rounded-xl bg-white/5 border border-white/10">
                ...
                <button
                  ...
                  className={`relative w-14 h-7 rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-[#df2531] focus:ring-offset-2 focus:ring-offset-black ${
                ...
                >
                  <span 
                    className={`absolute top-1 left-1 w-5 h-5 rounded-full bg-white transition-transform shadow-lg ${
                      isPremium ? 'translate-x-7' : 'translate-x-0'
                    }`}
                    aria-hidden="true"
                  />
                </button>
