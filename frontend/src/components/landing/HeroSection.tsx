          ...
          >
            <Link href="/dashboard">
              <Button 
                ...
                className="group relative bg-[#df2531] hover:bg-transparent text-white font-bold px-10 md:px-12 py-5 md:py-6 rounded-full text-sm md:text-base border-2 border-[#df2531] overflow-hidden transition-all duration-300 hover:scale-105 active:scale-95"
              >
                <span className="relative flex items-center gap-3">
                  <span className="text-white group-hover:text-[#df2531] transition-colors duration-300">Negotiate</span>
                  <span className="flex items-center justify-center w-8 h-8 rounded-full bg-white/20 group-hover:bg-[#df2531]/20 transition-all duration-300">
