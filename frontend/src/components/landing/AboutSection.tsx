      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-5">
          ...
          <div 
            ...
            onMouseLeave={() => setHoveredIndex(null)}
          >
            <Image src={aboutImages[1]} alt="Exclusive" fill className="object-cover transition-transform duration-700 group-hover:scale-110" />
          ...
          <div 
            ...
            onMouseLeave={() => setHoveredIndex(null)}
          >
            <Image src={aboutImages[2]} alt="Curated" fill className="object-cover transition-transform duration-700 group-hover:scale-110" />
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent" />
          ...
          <div 
            ...
            onMouseLeave={() => setHoveredIndex(null)}
          >
            <Image src={aboutImages[4]} alt="Sophisticated" fill className="object-cover transition-transform duration-700 group-hover:scale-105" />
